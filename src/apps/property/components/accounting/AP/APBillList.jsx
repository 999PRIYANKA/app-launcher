...
const APBillList = ({ bills, onAddClick, onSelect }) => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'Open': return { color: '#854d0e', bg: '#fef9c3' };
  ...
  return (
    <div className="flex h-full bg-white flex-col p-6">
        <div className="flex justify-between mb-6">
            ...
            >
                <Icons.PlusCircleIcon className="w-4 h-4 mr-2" /> New Bill
            </button>
        </div>

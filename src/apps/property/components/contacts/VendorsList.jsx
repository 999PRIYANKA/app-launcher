...
const VendorsList = ({ vendors, onAddClick, onSelect }) => {
  ...
  const filteredVendors = useMemo(() => {
    ...
    if (searchTerm.trim()) {
      ...
      filtered = filtered.filter(v => 
        ...
        (v.contactName && v.contactName.toLowerCase().includes(search)) ||
  ...
  return (
    <div className="flex h-full bg-white flex-col p-6">
        ...
        <div className="flex justify-between mb-6">
            ...
            >
                <Icons.PlusCircleIcon className="w-4 h-4 mr-2" /> Add Vendor
            </button>
        </div>

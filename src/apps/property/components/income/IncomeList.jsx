...
const IncomeList = ({ incomes, onAddIncomeClick, onSelectIncome }) => {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-2 w-full">
            ...
            <div className="relative flex-1">
              ...
              <input 
                type="text" 
                placeholder="Search by payer, property, category..." 
          ...
          >
            <span className="mr-1">+</span> Record Income
          </button>
        </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-white">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-r border-gray-100">Payer</th>
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {incomes.length > 0 ? (
                  incomes.map((income) => (
                    <tr key={income.id} className="hover:bg-gray-50 transition-colors cursor-pointer" onClick={() => onSelectIncome(income)}>
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-gray-500">
                      <div className="flex flex-col items-center">
                        <Icons.BanknotesIcon className="w-12 h-12 text-gray-300 mb-2" />

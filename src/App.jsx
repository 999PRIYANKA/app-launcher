...
import SoftPhoneWidget from './apps/crm-connect/components/SoftPhoneWidget';
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {siteMode === 'backend' && (
        <div className="relative h-screen flex overflow-hidden bg-gray-100 font-sans text-gray-800">
          ...
          {currentApp !== 'CRMConnect' && <SoftPhone />}
          
          {/* CRM Connect SoftPhone Widget: Only show when CRM Connect app is active */}
          {currentApp === 'CRMConnect' && <SoftPhoneWidget />}
        </div>
      )}
